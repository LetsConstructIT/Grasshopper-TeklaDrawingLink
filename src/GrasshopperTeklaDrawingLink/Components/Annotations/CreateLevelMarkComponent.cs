...
namespace GTDrawingLink.Components.Annotations
{
    public class CreateLevelMarkComponent : CreateDatabaseObjectComponentBaseNew<CreateLevelMarkCommand>
    {
        ...
        protected override IEnumerable<DatabaseObject> InsertObjects(IGH_DataAccess DA)
        {
            ...
            var strategy = GetSolverStrategy(insertionPoints, basePoints, attributes);
    ...
    public class CreateLevelMarkCommand : CommandBase
    {
        ...
        internal (ViewCollection views, TreeData<Point3d> basePoint, TreeData<Point3d> insertionPoint, TreeData<string> attributes) GetInputValues()
        {
