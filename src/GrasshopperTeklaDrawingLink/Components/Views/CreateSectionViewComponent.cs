...
{
    public class CreateSectionViewComponent : CreateViewBaseComponentNew<CreateSectionViewCommand>
    {
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        protected override Bitmap Icon => Properties.Resources.SectionView;

        public CreateSectionViewComponent() : base(ComponentInfos.CreateSectionViewComponent) { }
        ...
        protected override IEnumerable<DatabaseObject> InsertObjects(IGH_DataAccess DA)
        {
            ...
            for (int i = 0; i < strategy.Iterations; i++)
            {
                ...
                (View view, SectionMark mark) = InsertView(views.Get(path),
        ...
        private (View view, SectionMark mark) InsertView(View view,
                                                         Point3d startPoint,
                                                         Point3d endPoint,
    ...
    public class CreateSectionViewCommand : CommandBase
    {
