...
namespace GTDrawingLink.Components.Views
{
    public class CreateCurvedSectionViewComponent : CreateViewBaseComponentNew<CreateCurvedSectionViewCommand>
    {
        ...
        {
            var (inputViews, startPoints, midPoints, endPoints, insertPoints, depthsUp, depthsDown, viewAttributes, markAttributes, scales, names) = _command.GetInputValues(out bool mainInputIsCorrect);
