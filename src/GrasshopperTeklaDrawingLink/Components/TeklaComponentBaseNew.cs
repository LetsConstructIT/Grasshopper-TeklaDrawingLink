    ...
    public abstract class TeklaComponentBaseNew<T> : TeklaComponentBase where T : CommandBase, new()
    {
        ...
        protected void RegisterInputParameters(GH_InputParamManager pManager, IEnumerable<InputParam> parameters)
        {
            var @switch = new Dictionary<Type, Action<InputParam, GH_InputParamManager>> {
                ...
                { typeof(GH_Integer), (param, manager) => AddIntegerParameter(manager, param.InstanceDescription, param.ParamAccess, param.IsOptional) },
                { typeof(GH_Interval), (param, manager) => AddIntervalParameter(manager, param.InstanceDescription, param.ParamAccess, param.IsOptional) },
                { typeof(GH_StructurePath), (param, manager) => AddPathParameter(manager, param.InstanceDescription, param.ParamAccess, param.IsOptional) },                
        ...
        protected void RegisterOutputParameters(GH_OutputParamManager pManager, IEnumerable<OutputParam> parameters)
        {
            var @switch = new Dictionary<Type, Action<OutputParam, GH_OutputParamManager>> {
                ...
                { typeof(GH_Integer), (param, manager) => AddIntegerParameter(manager, param.InstanceDescription, param.ParamAccess) },
                { typeof(GH_Interval), (param, manager) => AddIntervalParameter(manager, param.InstanceDescription, param.ParamAccess) },
                { typeof(GH_StructurePath), (param, manager) => AddPathParameter(manager, param.InstanceDescription, param.ParamAccess) },
