...
namespace GTDrawingLink.Components
{
    public class GetDrawingPropertiesComponent : TeklaComponentBaseNew<GetDrawingPropertiesCommand>
    {
        ...
        protected override void InvokeCommand(IGH_DataAccess DA)
        {
            ...
            _command.SetOutputValues(DA, drawing.Name, drawing.Title1, drawing.Title2, drawing.Title3, sheetNumber, sheetSize.Width, sheetSize.Height);
        }
    ...
    public class GetDrawingPropertiesCommand : CommandBase
    {
        ...
        private readonly OutputParam<int> _outSheetNumber = new OutputParam<int>(new GH_InstanceDescription("Sheet No", "N", "Sheet number", "", ""));
        ...
        internal Result SetOutputValues(IGH_DataAccess DA, string name, string title1, string title2, string title3, int sheetNumber, double width, double height)
        {
            _outName.Value = name;
