...
namespace GTDrawingLink.Components.Drawings
{
    public class ModifyDrawingPropertiesComponent : TeklaComponentBaseNew<ModifyDrawingPropertiesCommand>
    {
        ...
        protected override void InvokeCommand(IGH_DataAccess DA)
        {
            ...
            _command.SetOutputValues(DA, drawing, drawing.Name, drawing.Title1, drawing.Title2, drawing.Title3, drawing.Mark, GetSheetNumber(drawing));
        }
    ...
    public class ModifyDrawingPropertiesCommand : CommandBase
    {
        ...
        private readonly OutputParam<string> _outMark = new OutputParam<string>(ParamInfos.DrawingMark);
        ...
        internal Result SetOutputValues(IGH_DataAccess DA, Drawing drawing, string name, string title1, string title2, string title3, string mark, int sheetNumber)
        {
