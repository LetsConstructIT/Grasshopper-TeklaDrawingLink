...
namespace DrawingLink.UI.GH.Models
{
    public class CatalogParamData : PersistableParam
    {
        ...
        public CatalogParamData(string fieldName, string name, string value, Func<string, string> pickFromCatalog, float top, TableColumnInfo tableColumnInfo) : base(fieldName, name, top, tableColumnInfo)
        {
